...
$(document).ready(() => {
  const links = [
    {
      name: "my discord",
      link: "discord.com/users/735967042221506562",
    },
    {
      name: "spotify",
      link: "open.spotify.com/user/hcyle17m0hlcfsevmlqgy6vmm",
    },
    {
      name: "guns",
      link: "guns.lol/zollach",
    },
    {
      name: "Minemen profile",
      link: "minemen.club/player/Zollach",
    },
    {
      name: "PvP teaching discord server ",
      link: "discord.gg/SjJ3zhyaWZ",
    },
    {
      name: "Twitter ",
      link: "x.com/BestInMyEra",
    },
  ];
  ...
  for (let i in links) {
    ...
    $("#marquee").append(
      `<a href="https://${link.link}" target="_BLANK">${link.name}</a>`
    );
    ...
    if (i != links.length - 1)
      $("#marquee").append(
        ' <img class="emoticon" src="assets/others/dot.png"> '
      );
  }
  ...
  app.titleChanger(["z", "zo", "zol", "zoll", "zolla", "zollac" , "zollach $"]);
  app.iconChanger([
    ...
    () => {
      ...
      writeLine(
        ...
        () => {
          ...
          writeLine(
            [`<i style='color: #F62459'>Zollach#9928 </i>`],
            120,
            500,
            () => {
              timeouts.push(
